"""Vendored from typeguard (https://github.com/agronholm/typeguard).

This module is a self-contained extraction of typeguard's type-checking
logic, with its internal dependencies (_config, _exceptions, _memo, _utils)
inlined so that confection can use it without adding typeguard as a
runtime dependency.

License: MIT (see typeguard's LICENSE file for details).
"""
...
# ============================================================================
# Inlined from typeguard._exceptions
# ============================================================================


class TypeHintWarning(UserWarning):
    """
    A warning that is emitted when a type hint in string form could not be
...
# ============================================================================
# Inlined from typeguard._config
# ============================================================================
...
# ============================================================================
# Inlined from typeguard._utils (only the bits _checkers.py needs)
# ============================================================================
...
# ============================================================================
# Inlined from typeguard._checkers
# ============================================================================
...
def check_type_internal(
    ...
    This function should only be used by type checker callables. Applications
    should use :func:`check_type` instead.

    :param value: the value to check
    :param annotation: the type annotation to check against
    :param memo: a memo object containing configuration and information
...
# Register the builtin checker lookup
checker_lookup_functions.append(builtin_checker_lookup)


# ============================================================================
# Convenience API for confection
# ============================================================================

# Default memo for simple type checking without forward ref context
_default_memo = TypeCheckMemo({}, {})


def check_type(value: Any, annotation: Any) -> None:
    """Check that *value* matches *annotation*, raising TypeCheckError if not."""
    check_type_internal(value, annotation, _default_memo)
