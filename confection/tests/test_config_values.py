...
from confection import Config, try_load_json
...
ini_scalar_value = st.one_of(
    ini_string_values.map(lambda s: _json_dumps(s)),
    ini_int_values,
    ini_float_values,
    ini_bool_values,
)
...
def test_positional_args_roundtrip(data):
    ...
    for key, value in parent_fields.items():
        lines.append(f"{key} = {_json_dumps(value)}")
...
# =============================================================================
# Schema Inference Tests (Schema.from_function / get_func_fields)
# =============================================================================
...
class TestMakeFuncSchema:
    """Tests for Schema.from_function inferring schemas from functions."""

    def test_schema_accepts_correct_int(self):
        """Schema accepts correct int type."""
        schema = Schema.from_function(make_test_func_int)
    ...
    def test_schema_accepts_correct_float(self):
        ...
        schema = Schema.from_function(make_test_func_float)
    ...
    def test_schema_requires_required_param(self):
        ...
        schema = Schema.from_function(make_test_func_optional)
        with pytest.raises(ValidationError):
    ...
    def test_schema_all_optional_uses_defaults(self):
        ...
        schema = Schema.from_function(make_test_func_all_optional)
    ...
    def test_schema_accepts_list(self):
        ...
        schema = Schema.from_function(make_test_func_list)
